...
func NewModel(token string, cfg *config.Config) Model {
	...
	return Model{
		...
		guildstree: guildstree.NewModel(cfg, state),
	}
}
...
func (m Model) ShortHelp() []key.Binding {
	cfg := m.cfg.Keybinds
	return []key.Binding{cfg.FocusGuildsTree.Binding, cfg.FocusMessagesList.Binding, cfg.FocusMessageInput.Binding, cfg.ToggleGuildsTree.Binding}
}
...
func (m Model) FullHelp() [][]key.Binding {
	...
	return [][]key.Binding{
		...
		{cfg.ToggleGuildsTree.Binding, cfg.Logout.Binding},
	}
}
