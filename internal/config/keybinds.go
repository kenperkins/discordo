...
type NavigationKeybinds struct {
	...
	PageUp   Keybind `toml:"page_up"`
	PageDown Keybind `toml:"page_down"`
}
...
func defaultKeybinds() Keybinds {
	return Keybinds{
		...
		Logout:           NewKeybind("ctrl+l", "logout"),
		...
		GuildsTree: GuildsTreeKeybinds{
			NavigationKeybinds: NavigationKeybinds{
				...
				PageUp:   NewKeybind("ctrl+u", "page up"),
				PageDown: NewKeybind("ctrl+d", "page down"),
			},
			Select: NewKeybind("enter", "select"),
		},
	}
}
